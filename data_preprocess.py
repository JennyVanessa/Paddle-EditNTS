...
from label_edit import sent2edit
# import nltk
...
if __name__=="__main__":
    train_df = process_raw_data("data/data-simplification/wikismall/PWKP_108016.tag.80.aner.test.src","data/data-simplification/wikismall/PWKP_108016.tag.80.aner.test.dst")   
    editnet_data_to_editnetID(train_df, "data/wikismall/test.df.filtered.pos")
